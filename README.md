...
- 适配国内四大主流教务系统：**正方 (新版)**、**URP 综合教务**、**青果 (Kingosoft)**、**强智 (Qiangzhi)**
- 采用模块化 Parser 架构，各类教务系统的页面与接口差异已被抹平，提供统一的数据结构
...
目前已深度适配 **正方**、**URP**、**青果**、**强智** 四大教务系统。导入体验如下：
...
- ✅ **核心升级：多教务系统支持**！底层重构引入 `Parser` 引擎，除新版正方外，新增适配 **URP、青果(Kingosoft)、强智** 三大主流教务系统。
